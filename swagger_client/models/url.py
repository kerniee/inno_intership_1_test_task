...
class URL(object):
    ...
    def __init__(self, authority=None, content=None, default_port=None, file=None, host=None, path=None, port=None, protocol=None, query=None, ref=None, user_info=None, _configuration=None):  # noqa: E501
