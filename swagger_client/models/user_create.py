...
class UserCreate(object):
    ...
    def __init__(self, email=None, username=None, id=None, password=None):  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this UserCreate.  # noqa: E501


        :return: The id of this UserCreate.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this UserCreate.


        :param id: The id of this UserCreate.  # noqa: E501
        :type: int
        """
        if id is None:
