...
class ByteArrayResource(object):
    ...
    def __init__(self, byte_array=None, description=None, file=None, filename=None, input_stream=None, open=None, readable=None, uri=None, url=None, _configuration=None):  # noqa: E501
